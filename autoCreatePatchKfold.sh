...
python3 createPatch.py ${image_path} ${modelweight_path} ${save_path} --output_layer ${OUTPUT_LAYER} --input_size ${INPUT_SIZE} --overlap ${OVERLAP} --gpu_ids ${GPU_IDS} --num_channel ${NUM_CHANNEL} ${mask}
