...
do
    ...
    python3 createThinPatch.py ${image_path} ${MODEL_PATH} ${save_path} --label_patch_size ${LABEL_PATCH_SIZE} --plane_size ${PLANE_SIZE} --overlap ${OVERLAP} --num_rep ${NUM_REP} --num_channel ${NUM_CHANNEL} --num_down ${NUM_DOWN} ${label} ${mask}
